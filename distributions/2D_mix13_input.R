...
#component4_sample <- function(n=1){
#  return(gen_beta_sample(n, a0_2, b0_2, a1_2, b1_2, a2_2, b2_2))
#}

#component4_pdf <- function(x){
#  return(gen_beta_density(x[,1], x[,2], a0_2, b0_2, a1_2, b1_2, a2_2, b2_2))
#}
...
component_sample = list(component1_sample, component2_sample, component5_sample) #component3_sample,component5_sample)
                        #component4_sample, component5_sample)
component_pdf = c(component1_pdf, component2_pdf, component5_pdf)  #component3_pdf, component5_pdf)
                  #component4_pdf, component5_pdf)
