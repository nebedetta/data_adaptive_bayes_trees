...
prefix = "1D_overlappingscales"
description = "Overlapping structures of different scales: sharp Beta(4000, 6000) spike inside the U(0.25,0.5)/Beta_[0.25,0.5](2,2) support"
...
# Component 4: Beta(4000, 6000), sharp spike centered at x=0.4 --
# overlaps spatially with component2/component3's [0.25, 0.5] support,
# unlike 1D_spikemix's Beta(6000, 4000) spike at x=0.6 (outside that support).
def component4_sample(size, seed=None):
    return np.random.beta(4000, 6000, size=size).reshape(-1, 1)

def component4_pdf(X):
    return beta.pdf(X, 4000, 6000)
